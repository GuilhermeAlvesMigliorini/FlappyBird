...
function Barreiras(altura, largura, abertura, esspaco, notificarPonto){
  this.pares = [
    new ParDeBarreiras(altura, abertura, largura),
    new ParDeBarreiras(altura, abertura, largura + esspaco),
    new ParDeBarreiras(altura, abertura, largura + esspaco * 2),
    new ParDeBarreiras(altura, abertura, largura + esspaco * 3)
  ]
  ...
  this.animar = () => {
    this.pares.forEach(par => {
      ...
      if(par.getX() < -par.getLargura()) {
        par.setX(par.getX() + esspaco * this.pares.length)
        par.sortearAbertura()
      }
